...
enum { dodawanie, odejmowanie, mnozenie, dzielenie, kwadrat, szescian, potega, pi, e, tworca }; 
...
pow( liczba, potega ). 
Jesli podasz np. liczby z duza iloscia miejsc po przecinku moze wyskoczyc w wyniku "#INF" - oznacza to ze
